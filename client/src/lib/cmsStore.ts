...
export const DEFAULT_CMS_DATA: CMSData = {
  ...
  categories: [
    ...
    { id: 3, name: 'Career & Employment Assets', icon: 'FileText', description: 'Resume versions, CVs, Offer & Relieving Letters, Pay Slips, Portfolios', documentCount: 4, color: '#F59E0B', displayOrder: 3, status: 'active', created_at: '2026-01-15T10:00:00Z' },
