        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-[#1B664B] flex items-center justify-center text-white shadow-md">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#121215] border border-zinc-800 shadow-sm w-fit whitespace-nowrap mt-1 hover:border-[#1B664B]/40 hover:bg-[#1B664B]/10 transition-colors duration-300 cursor-default">
              <Lock className="w-3.5 h-3.5 text-[#1B664B]" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2.5 text-zinc-300">
                <MapPin className="w-4 h-4 text-[#1B664B] shrink-0 mt-0.5" />
                <span>{footerInfo.address}</span>
              </li>
              <li className="flex items-center gap-2.5 text-zinc-300">
                <Phone className="w-4 h-4 text-[#1B664B] shrink-0" />
                <span>{footerInfo.phone}</span>
              </li>
              <li className="flex items-center gap-2.5 text-zinc-300">
                <Mail className="w-4 h-4 text-[#1B664B] shrink-0" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/" className="inline-flex hover:text-[#1B664B] hover:translate-x-1 transition-all duration-300">Home</Link>
              </li>
              <li>
                <Link href="/login" className="inline-flex hover:text-[#1B664B] hover:translate-x-1 transition-all duration-300">Sign In to Vault</Link>
              </li>
              <li>
                <Link href="/register" className="inline-flex hover:text-[#1B664B] hover:translate-x-1 transition-all duration-300">Create Account</Link>
              </li>
              <li>
                <Link href="/admin" className="inline-flex hover:text-[#1B664B] hover:translate-x-1 transition-all duration-300">Admin Control Center</Link>
              </li>
            </ul>
          </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              {socials.map((soc) => (
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-[#121215] border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-[#1B664B] hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(27,102,75,0.5)] hover:border-[#1B664B] transition-all duration-300"
                  title={soc.platform}
                >
