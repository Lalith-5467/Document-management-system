...
export default function HomePage() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white">
        <div className="w-16 h-16 rounded-3xl bg-gradient-to-tr from-themePrimary to-[#F97316] flex items-center justify-center text-white shadow-xl shadow-orange-500/30 animate-pulse border border-orange-400/20">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-slate-900 font-sans relative selection:bg-[#FF6B00] selection:text-white">
      ...
      {cms.hero?.enabled !== false && (
        <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 z-10 w-full overflow-hidden bg-white">
          ...
          <div className="absolute top-12 left-1/4 w-80 h-80 bg-orange-400/10 rounded-full blur-3xl pointer-events-none animate-float-slow" />
          <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-amber-400/10 rounded-full blur-3xl pointer-events-none animate-float-reverse" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-orange-100/30 rounded-full blur-3xl pointer-events-none animate-pulse-subtle" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8 animate-fade-up">
            <div className="space-y-4 max-w-4xl mx-auto">
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-slate-900 tracking-tight leading-[1.1]">
                {cms.hero.title}{' '}
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-themePrimary via-[#F97316] to-themePrimary animate-gradient-flow">
                  {cms.hero.highlight}
                </span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-themePrimary via-[#F97316] to-themePrimary text-white font-black shadow-xl shadow-orange-500/25 hover:shadow-2xl hover:shadow-orange-500/40 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 shine-button-effect group"
              >
              ...
              <Link
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/90 backdrop-blur-md border-2 border-slate-200 text-slate-700 font-black hover:border-themePrimary/60 hover:text-themePrimary hover:bg-orange-50/60 transition-all duration-300 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 shadow-xs hover:shadow-md"
              >
            ...
            {cms.hero.dashboardImage && (
              <div className="pt-12 md:pt-16 max-w-5xl mx-auto relative">
                ...
                <div className="hidden sm:flex absolute -bottom-3 -right-4 md:-right-8 z-30 px-4 py-2.5 rounded-2xl bg-white/95 backdrop-blur-md border border-orange-200/80 shadow-xl shadow-orange-500/15 items-center gap-2.5 animate-float-reverse hover:scale-105 transition-transform duration-300 cursor-default">
                  <div className="w-6 h-6 rounded-lg bg-orange-50 text-themePrimary flex items-center justify-center border border-orange-200/60">
                ...
                <div className="relative rounded-3xl overflow-hidden border border-slate-200 shadow-2xl shadow-slate-900/10 bg-white group hover:shadow-orange-500/15 hover:border-orange-200 transition-all duration-500">
      ...
      {activeFeatures.length > 0 && (
        <section id="features" className="scroll-mt-24 pt-12 pb-16 bg-[#F8FAFC] border-b border-slate-200/80 relative z-10 overflow-hidden">
          ...
          <div className="absolute top-1/3 -right-20 w-80 h-80 bg-orange-400/8 rounded-full blur-3xl pointer-events-none animate-float-slow" />
          <div className="absolute bottom-10 -left-20 w-80 h-80 bg-amber-400/8 rounded-full blur-3xl pointer-events-none animate-float-reverse" />

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14 relative z-10">
            <div className="text-center max-w-2xl mx-auto space-y-3.5">
              <span className="text-xs font-black uppercase tracking-wider text-themePrimary font-mono px-4 py-1.5 rounded-full bg-orange-50 border border-orange-200 inline-flex items-center gap-1.5 shadow-2xs">
                <Sparkles className="w-3.5 h-3.5 text-themePrimary animate-badge-sparkle" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {activeFeatures.map((feat, idx) => (
                <div
                  key={feat.id}
                  className="landing-card relative p-7 space-y-5 group bg-white border border-slate-200/80 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 rounded-[20px] overflow-hidden cursor-default"
                  style={{ animationDelay: `${idx * 80}ms` }}
                >
                  {/* Animated Box Outline on Hover */}
                  ...
                  <div className="relative z-10 w-12 h-12 rounded-2xl bg-orange-50 text-themePrimary flex items-center justify-center border border-orange-200/80 group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-lg group-hover:shadow-orange-500/25 transition-all duration-300">
      ...
      {activeCategories.length > 0 && (
        <section id="categories" className="scroll-mt-24 py-16 bg-white border-b border-slate-200/80 relative z-10 overflow-hidden">
          {/* Ambient Background Light */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-orange-500/5 rounded-full blur-3xl pointer-events-none animate-pulse-subtle" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {activeCategories.map((cat, idx) => (
                <Link
                  key={cat.id}
                  href="/register"
                  className="landing-card p-6 border-t-4 border-t-themePrimary flex flex-col justify-between group hover:-translate-y-2 hover:shadow-2xl transition-all duration-300"
                  style={{ animationDelay: `${idx * 80}ms` }}
                >
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div
                        className="w-11 h-11 rounded-2xl flex items-center justify-center text-white shadow-md group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 bg-gradient-to-tr from-themePrimary to-[#F97316]"
                      >
                        {renderIcon(cat.icon, UserCheck)}
                      </div>
                      <span className="text-xs font-black px-3 py-1 rounded-full bg-orange-50 text-themePrimary border border-orange-200 font-mono group-hover:scale-105 group-hover:bg-orange-100 transition-all">
                    ...
                    <div>
                      <h3 className="text-lg font-black text-slate-900 group-hover:text-themePrimary transition-colors flex items-center justify-between">
                        {cat.name}
                        <ArrowRight className="w-4 h-4 text-themePrimary opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-300" />
                      </h3>
      ...
      {activeAudience.length > 0 && (
        <section id="solutions" className="scroll-mt-24 py-16 bg-[#F8FAFC] border-b border-slate-200/80 relative z-10 overflow-hidden">
          ...
          <div className="absolute top-10 right-10 w-96 h-96 bg-orange-500/6 rounded-full blur-3xl pointer-events-none animate-float-slow" />
          <div className="absolute bottom-10 left-10 w-96 h-96 bg-amber-500/6 rounded-full blur-3xl pointer-events-none animate-float-reverse" />

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
            <div className="text-center max-w-3xl mx-auto space-y-4">
              <span className="text-xs font-black uppercase tracking-widest text-themePrimary font-mono px-4 py-1.5 rounded-full bg-orange-50 border border-orange-200 inline-flex items-center gap-1.5 shadow-2xs">
                <Sparkles className="w-3.5 h-3.5 text-themePrimary animate-badge-sparkle" />
                  ...
                  >
                    ...
                    <div className="space-y-6 relative z-10 flex-1">
                      <div className="flex items-start justify-between">
                        <div className="w-14 h-14 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-lg group-hover:shadow-orange-500/20 transition-all duration-300 bg-orange-50 text-themePrimary border border-orange-200/80">
                          {renderIcon(userGroup.icon, GraduationCap)}
                        </div>
                        <span className="text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-full text-slate-500 bg-slate-100 border border-slate-200/80 shadow-xs group-hover:border-orange-200 group-hover:text-themePrimary transition-colors">
                          {userGroup.badge}
                        </span>
                      </div>
                      ...
                      <div className="space-y-3 pt-5 border-t border-slate-100">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(userGroup.features || []).map((feat, fIdx) => (
                            <div
                              key={fIdx}
                              className="flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1.5 rounded-lg bg-slate-50 border border-slate-100 text-slate-600 group-hover:border-orange-200 group-hover:bg-orange-50/80 group-hover:text-slate-800 hover:scale-105 transition-all duration-200 cursor-default"
                            >
      ...
      {activeFaqs.length > 0 && (
        <section id="faq" className="scroll-mt-24 py-16 bg-white border-b border-slate-200/80 relative z-10 overflow-hidden">
          {/* Ambient Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-orange-500/5 rounded-full blur-3xl pointer-events-none animate-pulse-subtle" />

          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
            <div className="text-center space-y-4">
              <span className="text-sm font-black uppercase tracking-widest text-themePrimary font-mono px-4 py-1.5 rounded-full bg-orange-50 border border-orange-200 inline-flex items-center gap-1.5 shadow-2xs">
                <Sparkles className="w-3.5 h-3.5 text-themePrimary animate-badge-sparkle" />
            ...
            <div className="space-y-4">
              {activeFaqs.map((faq) => {
                ...
                return (
                  <div
                    key={faq.id}
                    className="bg-white rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-md hover:border-orange-200/80 transition-all duration-300 overflow-hidden group"
                  >
                    <button
                      onClick={() => setOpenFaq(isOpen ? null : faq.id)}
                      className="w-full py-5 px-6 sm:px-8 text-left flex items-center justify-between gap-4 font-extrabold text-base sm:text-lg text-slate-900 hover:text-themePrimary transition-colors cursor-pointer"
                    >
                      <span className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-xl bg-orange-50 text-themePrimary flex items-center justify-center shrink-0 border border-orange-200/80 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
      ...
      {cms.cta?.enabled !== false && (
        <section className="py-20 bg-white relative z-10 overflow-hidden">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative rounded-[28px] p-8 sm:p-14 text-center text-white space-y-6 shadow-2xl shadow-orange-500/30 overflow-hidden bg-gradient-to-r from-themePrimary via-[#F97316] to-themePrimary animate-gradient-flow">
              {cms.cta?.bgImage && (
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 pt-3 relative z-10">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 text-xs sm:text-sm font-black text-themePrimary bg-white hover:bg-orange-50 rounded-2xl shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 shine-button-effect group"
                >
                  <span>{cms.cta?.primaryBtnText || 'Create Free Account'}</span>
                  <ArrowRight className="w-4 h-4 text-themePrimary group-hover:translate-x-1 transition-transform" />
                </Link>
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 p-3.5 rounded-2xl bg-white/95 backdrop-blur-md border border-orange-200/80 text-themePrimary shadow-xl shadow-orange-500/20 hover:bg-themePrimary hover:text-white hover:border-themePrimary hover:scale-110 active:scale-95 transition-all duration-300 group cursor-pointer animate-zoom-in"
