      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-2xs font-extrabold uppercase tracking-widest text-[#FF6B00] font-mono">
              DYNAMIC CMS ENGINE
            </span>
          </div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2 font-auth-heading">
            <Layout className="w-6 h-6 text-[#FF6B00]" />
          ...
          <div className="p-6 rounded-3xl border border-slate-200 bg-white shadow-xs space-y-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-100/80 border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:border-[#FF6B00] font-medium"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 bg-slate-100/80 border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:border-[#FF6B00] resize-none font-medium"
              />
            </div>
      ...
      {activeTab === 'stats' && (
        <form onSubmit={handleSaveStats} className="space-y-6">
          <div className="p-6 rounded-3xl border border-slate-200 bg-white shadow-xs space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <h2 className="text-base font-black text-slate-900 flex items-center gap-2">
                <Layout className="w-4 h-4 text-[#FF6B00]" />
            ...
            <form onSubmit={handleItemSubmit} className="space-y-3.5 text-xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2 bg-slate-100/80 border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:border-[#FF6B00] resize-none font-medium"
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2 bg-slate-900 border border-slate-200 rounded-xl text-xs text-white focus:outline-none focus:border-[#FF6B00]"
                  >
          ...
          <div className="space-y-5">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-8 pr-3 py-2 text-2xs bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 w-44 focus:outline-none focus:border-[#FF6B00]"
                    />
                  </div>
                  <select
                    value={statusFilter}
                  ...
                  <button
                    onClick={() => { setFormData({ displayOrder: slides.length + 1, status: 'active', accentGradient: 'from-[#FF6B00] via-[#F97316] to-[#FF8A00]', accentColor: 'text-[#FF6B00]', primaryCtaHref: '/register', secondaryCtaHref: '/login', secondaryCtaLabel: 'Sign In to Vault' }); setModal({ type: 'create', module: 'carousel' }); }}
                    className="px-4 py-2 rounded-xl bg-gradient-to-r from-[#FF6B00] to-[#F97316] hover:from-[#EA580C] hover:to-[#FF6B00] text-white text-2xs font-bold flex items-center gap-1.5 transition shadow-sm cursor-pointer"
                  >
            ...
            {paginated.length === 0 ? (
              <div className="p-16 text-center text-xs text-slate-500 rounded-3xl border border-slate-200 bg-white shadow-2xs font-medium">
                No carousel slides found. Click <strong className="text-[#FF6B00]">Add Slide</strong> to create your first one.
              </div>
            ) : (
                  ...
                  <div key={slide.id} className="group relative rounded-3xl border border-slate-200 bg-white overflow-hidden shadow-xs hover:border-orange-500/40 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="relative h-44 overflow-hidden bg-slate-100">
                        ...
                        {/* Top Left Badge */}
                        <span className="absolute top-3 left-3 px-3 py-1 rounded-full text-[10px] font-extrabold bg-[#FF6B00]/95 text-white shadow-md border border-white/20 backdrop-blur-sm max-w-[65%] truncate">
                          {slide.badge || 'Slide'}
                        </span>
                        ...
                        <div className="absolute bottom-3 left-3 w-6 h-6 rounded-lg bg-black/40 backdrop-blur-md flex items-center justify-center border border-white/20">
                          <input
                            ...
                            className="w-3.5 h-3.5 rounded cursor-pointer accent-[#FF6B00]"
                          />
                        </div>
                      </div>
                      ...
                      <div className="p-5 space-y-2 bg-white">
                        ...
                        <div className="flex items-center gap-2 pt-2.5 border-t border-slate-100 mt-3">
                          ...
                          <span className="text-xs text-[#FF6B00] font-bold truncate max-w-[130px]">{slide.primaryCtaLabel}</span>
                  ...
                  <form onSubmit={handleItemSubmit} className="p-6 space-y-4 overflow-y-auto max-h-[80vh]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          value={formData.accentGradient || 'from-[#FF6B00] via-[#F97316] to-[#FF8A00]'}
                          onChange={e => setFormData((p: any) => ({ ...p, accentGradient: e.target.value }))}
                          placeholder="from-[#FF6B00] via-[#F97316] to-[#FF8A00]"
                          className="w-full px-4 py-2.5 bg-slate-100/80 border border-slate-200 rounded-xl text-xs text-slate-900 font-mono font-medium focus:outline-none focus:ring-1 focus:ring-orange-500/50"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          value={formData.accentColor || 'text-[#FF6B00]'}
        ...
        <div className="flex items-center gap-2 flex-1">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 font-medium placeholder-slate-400 focus:outline-none focus:border-[#FF6B00]"
            />
          </div>
                  ...
                  <td className="py-3.5 px-4">
                    <div className="flex items-center gap-3">
                      {item.image || item.photo || item.logo ? (
                        ...
                        <div className="w-8 h-8 rounded-lg bg-orange-50 border border-orange-200/80 text-[#FF6B00] flex items-center justify-center shrink-0">
