...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="max-w-4xl space-y-8 pb-12 text-slate-900 font-sans">
      {/* Toast Alert */}
      {toastMsg && (
        <div className="fixed bottom-6 right-6 z-[9999] flex items-center gap-3 px-5 py-3.5 rounded-2xl bg-white text-slate-900 border border-[#FF6B00]/30 shadow-2xl text-xs font-semibold animate-pop-in">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h2 className="text-sm font-black text-slate-900 flex items-center gap-2 font-auth-heading">
                <Cpu className="w-4 h-4 text-[#FF6B00]" /> System Specs & Environment Information
              </h2>
            </div>
          ...
          <form onSubmit={handleSaveConfig} className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h2 className="text-sm font-black text-slate-900 flex items-center gap-2 font-auth-heading">
                <HardDrive className="w-4 h-4 text-[#FF6B00]" /> Storage & File Limit Controls
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 font-bold focus:outline-none focus:border-[#FF6B00] cursor-pointer"
                >
                  ...
                  return (
                    <button
                      ...
                      className={`p-3.5 rounded-2xl border text-left transition flex items-center justify-between cursor-pointer ${
                        isChecked
                          ? 'border-[#FF6B00] bg-orange-50/60 text-slate-900 font-extrabold'
                    ...
                    >
                      ...
                      {isChecked && <Check className="w-4 h-4 text-[#FF6B00] shrink-0" />}
                    </button>
                  );
                })}
              </div>
      ...
      {isBackupModalOpen && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md p-6 rounded-3xl border border-slate-200 shadow-2xl space-y-5">
            <div className="w-12 h-12 rounded-2xl bg-orange-50 text-[#FF6B00] flex items-center justify-center border border-orange-200">
            ...
            <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-2xl text-xs font-black text-white bg-gradient-to-r from-[#FF6B00] to-[#F97316] hover:opacity-90 shadow-md shadow-orange-500/20 transition cursor-pointer">
                {isDownloadingBackup ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin" />
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md p-6 rounded-3xl border border-slate-200 shadow-2xl space-y-5">
            ...
            <div className="space-y-2">
              ...
              >
                <Upload className="w-5 h-5 text-[#FF6B00] mx-auto" />
