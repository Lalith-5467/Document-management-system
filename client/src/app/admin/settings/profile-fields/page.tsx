      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100 dark:border-slate-800">
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white flex items-center gap-2 font-auth-heading">
            <UserCircle className="w-6 h-6 text-themePrimary" /> Profile Fields
          </h1>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse table-fixed">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/80">
              {fields.map(field => (
                <tr key={field.id} className="hover:bg-orange-50/20 dark:hover:bg-slate-800/50 transition-colors group">
                  <td className="px-6 py-4">
                    <GripVertical className="w-4 h-4 text-slate-300 dark:text-slate-600 cursor-grab hover:text-themePrimary transition-colors" />
                  </td>
                  <td className="px-6 py-4">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl w-full max-w-md shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden text-slate-900 dark:text-white">
            ...
            <form onSubmit={handleSave}>
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-900 dark:text-white focus:outline-none focus:border-themePrimary transition"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-mono font-bold text-slate-900 dark:text-white focus:outline-none focus:border-themePrimary transition disabled:opacity-50"
                ...
                <div className="pt-2 flex flex-col gap-3">
                  <label className="flex items-center gap-3 cursor-pointer p-3 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition">
                    <input 
                      ...
                      disabled={['full_name', 'email'].includes(formData.name)}
                      className="w-4 h-4 text-themePrimary focus:ring-themePrimary border-slate-300 rounded disabled:opacity-50 cursor-pointer"
                    />
                    <div>
              ...
              <div className="p-5 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-themePrimary to-[#F97316] text-white font-black text-xs shadow-md shadow-orange-500/20 hover:opacity-90 hover:scale-105 transition cursor-pointer"
                >
