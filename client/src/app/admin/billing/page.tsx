...
`;
  ...
  return (
    <div className="space-y-8 pb-16 text-slate-900 font-sans">
      {/* Toast Alert */}
      {toastMessage && (
        <div className="fixed bottom-6 right-6 z-[999] flex items-center gap-3 px-5 py-3.5 rounded-2xl bg-white text-slate-900 border border-[#FF6B00]/30 shadow-2xl shadow-orange-500/10 text-xs font-semibold animate-pop-in">
        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-pop-in overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-8 shadow-2xl border border-slate-200 relative space-y-6 my-6 text-xs text-slate-700">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                <span className="font-mono text-xs font-bold text-[#FF6B00]">Invoice #{selectedInvoice.invoiceNo}</span>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
              <p className="font-extrabold uppercase text-[10px] text-slate-500 tracking-wider flex items-center gap-1.5">
                <User className="w-3.5 h-3.5 text-[#FF6B00]" /> Customer CRM Details
              </p>
              <div className="grid grid-cols-2 gap-2 text-xs font-medium text-slate-800">
                ...
                <div><span className="text-slate-500">Plan:</span> <span className="font-bold text-[#FF6B00]">{selectedInvoice.planName}</span></div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
              ...
              <div className="flex justify-between text-sm font-black text-slate-900 pt-2 border-t border-slate-200">
                ...
                <span className="text-[#FF6B00]">₹{selectedInvoice.totalAmount.toFixed(2)}</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-[#FF6B00] hover:bg-[#EA580C] text-white font-bold text-xs shadow-md flex items-center gap-1.5 transition cursor-pointer"
              >
            ...
            <form onSubmit={handleCreateBill} className="space-y-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-100/80 border border-slate-200 text-xs font-semibold text-slate-900 focus:outline-none focus:border-[#FF6B00]"
                />
              </div>
