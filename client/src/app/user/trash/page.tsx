    ...
    <div className="space-y-6 pb-12 font-sans">
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-[#111827] p-16 rounded-3xl border border-slate-200 dark:border-slate-800 text-center space-y-4 shadow-md max-w-md mx-auto">
          ...
          <Link
            href="/user/documents"
            className="inline-flex items-center gap-1.5 text-sm font-bold text-[#1B664B] dark:text-[#1B664B] hover:text-[#1B664B] dark:hover:text-[#1B664B] bg-[#E8F5F0] dark:bg-emerald-950/60 px-4 py-2 rounded-xl border border-[#D1EBE1] dark:border-emerald-900/60 transition"
          >
            Go to My Documents
          </Link>
        </div>
