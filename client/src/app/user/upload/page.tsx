...
const DEFAULT_CATEGORIES = [
  { id: '1', name: 'Personal Documents', icon: '👤', color: '#FF6B00' },
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-all duration-300 relative group overflow-hidden ${
              fileTouched && fileError
                ...
                : 'border-slate-200 dark:border-slate-800 hover:border-[#FF6B00]/80 bg-slate-50 dark:bg-[#0b1120]/60 hover:bg-slate-100 dark:hover:bg-[#0b1120]'
            }`}
          >
            {selectedFile ? (
              ...
              <div className="space-y-3 font-auth-body">
                <div className="w-14 h-14 rounded-2xl bg-orange-50 dark:bg-orange-600/10 border border-orange-200 dark:border-orange-500/20 text-[#FF6B00] dark:text-orange-400 flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="space-y-1 border-t border-slate-200 dark:border-slate-800 pt-1">
                  {filteredFoldersList.map((f) => {
                    ...
                    return (
                      ...
                      >
                        <span className="flex items-center gap-2 truncate">
                          <FolderClosed className="w-3.5 h-3.5 text-[#FF6B00] dark:text-orange-400 shrink-0" />
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`w-11 h-6 rounded-full p-0.5 transition-colors duration-200 ease-in-out cursor-pointer ${
                isFavorite ? 'bg-[#FF6B00]' : 'bg-slate-300 dark:bg-slate-800'
              }`}
            >
              <div
        ...
        <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-3 font-auth-body">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <span className="p-1.5 rounded-lg bg-orange-100 text-[#FF6B00] dark:bg-orange-950 dark:text-orange-400">
                🔒
              </span>
              <div>
            ...
            <button
              ...
              className={`w-11 h-6 rounded-full p-0.5 transition-colors duration-200 cursor-pointer ${
                isPasswordProtected ? 'bg-[#FF6B00]' : 'bg-slate-300 dark:bg-slate-800'
              }`}
            >
              <div
        ...
        {uploading && (
          <div className="space-y-2 pt-2 font-auth-body">
            <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-300">
              ...
              <span className="font-auth-label text-[#FF6B00] dark:text-orange-400">{uploadProgress}%</span>
            </div>
            <div className="w-full h-2.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden border border-slate-200 dark:border-slate-700">
              <div
                className="h-full bg-gradient-to-r from-[#FF6B00] via-[#F97316] to-[#EA580C] transition-all duration-300 rounded-full"
            ...
            <form onSubmit={handleCreateFolderInline} className="space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-[#0b1120] border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white focus:outline-none focus:border-[#FF6B00] font-auth-body"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-[#0b1120] border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white focus:outline-none focus:border-[#FF6B00] resize-none font-auth-body"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-800">
                ...
                <button type="submit" disabled={creatingFolder} className="px-4 py-2 rounded-xl bg-gradient-to-r from-[#FF6B00] to-[#F97316] hover:brightness-110 text-white font-bold flex items-center gap-2 shadow-lg shadow-orange-500/25 font-auth-heading">
